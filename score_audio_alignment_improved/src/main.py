...
AUDIO_FEATURE_BACKEND = "chroma_cqt"
SCORE_FEATURE_BACKEND = "basic_chroma"
...
def main() -> None:
    ...
    score_chroma = compute_score_features(
        note_array,
        score_times,
        backend=SCORE_FEATURE_BACKEND,
    )

    audio_chroma = compute_audio_features(
        audio,
        sr,
        backend=AUDIO_FEATURE_BACKEND,
